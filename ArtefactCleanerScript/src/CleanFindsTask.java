...
public class CleanFindsTask extends Task {
  ...
  public boolean canExecute() {
    ...
    return snapshot.containsAll(ArtefactCleanerScript.TOOLS) &&
      snapshot.contains(ItemID.UNCLEANED_FIND) &&
      snapshot.isFull();
  }

  @Override
  public boolean execute() {
    RSObject table = script.getObjectManager().getClosestObject(script.getWorldPosition(), "Specimen table");
    if (table == null) {
